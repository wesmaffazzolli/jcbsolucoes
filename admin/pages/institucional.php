...
if(isset($_GET['source'])) {
	...
	if(isset($_POST['update_institucional']) || isset($_POST['update_missao']) || isset($_POST['update_visao']) || isset($_POST['update_objetivos'])) {
        ...
        if(isset($_POST['institucional_text'])){$institucional_text = escape($_POST['institucional_text']);}else{$institucional_text = "";};
			    ...
			    <div class="panel-body">
					<form action="" method="post">
					    ...
					    <div class="form-group">
					        <textarea type="text" name="institucional_text" class="form-control" cols="30" rows="5" maxlength="700"><?php if(isset($institucional_text)){echo $institucional_text;}else{echo "Vazio.";} ?></textarea>
					        <p class="help-block">Max 700 caracteres.</p>
					    </div>
					    <div class="form-group">
					        <input class="btn botao-crud" type="submit" name="update_institucional" value="Atualizar">
					    </div>
					</form>
				</div>
				<!-- Panel Body End -->
			...
			<div class="panel panel-default">
			    ...
			    <div class="panel-body">
					<form action="" method="post">
					    ...
					    <div class="form-group">
					        <textarea type="text" name="missao_text" class="form-control" cols="5" rows="5" maxlength="250"><?php if(isset($institucional_missao_text)){echo $institucional_missao_text;}else{echo "Vazio.";} ?></textarea>
					        <p class="help-block">Max 250 caracteres.</p>
					    </div>
					    <div class="form-group">
					        <input class="btn botao-crud" type="submit" name="update_missao" value="Atualizar">
					    </div>
					</form>
				</div>
				<!-- Panel Body End -->
			...
			<div class="panel panel-default">
			    ...
			    <div class="panel-body">
					<form action="" method="post">
					    ...
					    <div class="form-group">
					        <textarea type="text" name="visao_text" class="form-control" cols="5" rows="5" maxlength="250"><?php if(isset($institucional_visao_text)){echo $institucional_visao_text;}else{echo "Vazio.";} ?></textarea>
					        <p class="help-block">Max 250 caracteres.</p>
					    </div>
					    <div class="form-group">
					        <input class="btn botao-crud" type="submit" name="update_visao" value="Atualizar">
					    </div>
					</form>
				</div>
				<!-- Panel Body End -->
			...
			<div class="panel panel-default">
			    ...
			    <div class="panel-body">
					<form action="" method="post">
					    ...
					    <div class="form-group">
					        <textarea type="text" name="objetivos_text" class="form-control" cols="5" rows="5" maxlength="250"><?php if(isset($institucional_objetivos_text)){echo $institucional_objetivos_text;}else{echo "Vazio.";} ?></textarea>
					        <p class="help-block">Max 250 caracteres.</p>
					    </div>
					    <div class="form-group">
					        <input class="btn botao-crud" type="submit" name="update_objetivos" value="Atualizar">
					    </div>
					</form>
				</div>
				<!-- Panel Body End -->
