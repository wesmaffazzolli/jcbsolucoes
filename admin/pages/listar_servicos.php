            ...
            <table class="table table-striped table-bordered table-hover">
				...
				<tbody>
		            ...
		            while($row = mysqli_fetch_assoc($select_services)) {
		                ...
		                echo "<td><a href='servicos.php?source=editar&p_id={$service_id}'>Editar</a>&nbsp;&nbsp;&nbsp;<a href='servicos.php?source=delete&p_id={$service_id}'>Excluir</a>&nbsp;&nbsp;&nbsp;<a href='servicos.php?source=view_images&p_id={$service_id}'>Ver Imagens</a>";
		                echo "</tr>";
